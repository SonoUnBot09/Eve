...
bool PipelineBuilder::BuildGraphicsPipelineInternal(ShaderInfo shaderInfo, const char* source, GraphicsShaderObject& shaderObject, MaterialProperties& properties)
{
    Shader shader = SlangCompiler::CompileVertFragInternal(shaderInfo.ShaderModule.c_str(), source);
...
bool PipelineBuilder::BuildComputePipelineInternal(std::string& shaderModule, const char* source, ComputeShaderObject& pipeline)
{
    Shader shader = SlangCompiler::CompileComputeInternal(shaderModule.c_str(), source);
